...
const WhatsAppIcon = ({ className }: { className?: string }) => (
    <img src="/images/whatsapp.png" alt="WhatsApp" className={className} width="16" height="16" />
);

const CallIcon = ({ className }: { className?: string }) => (
    <img src="/images/call.png" alt="Call" className={className} width="16" height="16" />
);
        ...
        <div className="min-h-screen bg-gruvbox-bg0 pt-16 sm:pt-24 md:pt-32 pb-12 sm:pb-20" dir={isUrdu ? "rtl" : "ltr"}>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    {/* Buy/Sell Section */}
                    <div className="bg-gruvbox-bg1 rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden shadow-xl border border-gruvbox-bg2 flex flex-col hover:border-gruvbox-blue/30 transition-colors">
                        <div className="h-40 sm:h-48 lg:h-56 relative overflow-hidden">
                            <img src={images.buySell} alt={t.contactBuySellTitle} loading="lazy" className="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition-transform duration-700" />
                        ...
                        <div className="p-6 sm:p-8 flex-grow flex flex-col">
                            ...
                            <div className="space-y-3 mt-auto">
                                <button onClick={() => navigate(`/${lang}/contactCEO?intent=buy`)} className={contactButtonClass}>
                    ...
                    <div className="bg-gruvbox-bg1 rounded-[2rem] overflow-hidden shadow-xl border border-gruvbox-bg2 flex flex-col hover:border-gruvbox-orange/30 transition-colors">
                        <div className="h-40 sm:h-48 lg:h-56 relative overflow-hidden">
                            <img src={images.rent} alt={t.contactRentTitle} loading="lazy" className="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition-transform duration-700" />
                            <div className="absolute inset-0 bg-black/40" />
                        </div>
                        <div className="p-6 sm:p-8 flex-grow flex flex-col">
                            <div className="bg-gruvbox-bg2 w-12 h-12 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
                            ...
                            <div className="space-y-3 mt-auto">
                                <button onClick={() => navigate(`/${lang}/contactAgentA?intent=rent`)} className={contactButtonClass}>
                                    <WhatsAppIcon className="h-4 w-4" />
                                    {t.contactChatAgent1}
                                </button>
                                <button onClick={() => navigate(`/${lang}/contactAgentB?intent=rent`)} className={contactButtonClass}>
                                    <WhatsAppIcon className="h-4 w-4" />
                                    {t.contactChatAgent2}
                                </button>
                                <button onClick={showCallError} className={contactButtonClass}>
                    ...
                    <div className="bg-gruvbox-bg1 rounded-[2rem] overflow-hidden shadow-xl border border-gruvbox-bg2 flex flex-col hover:border-gruvbox-green/30 transition-colors md:col-span-2 lg:col-span-1">
                        <div className="h-40 sm:h-48 lg:h-56 relative overflow-hidden">
                            <img src={images.list} alt={t.contactListTitle} loading="lazy" className="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition-transform duration-700" />
                            <div className="absolute inset-0 bg-black/40" />
                        </div>
                        <div className="p-6 sm:p-8 flex-grow flex flex-col">
                            <div className="bg-gruvbox-bg2 w-12 h-12 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
                            ...
                            <div className="space-y-3 mt-auto">
                                <button onClick={() => navigate(`/${lang}/contactCEO?intent=sell`)} className={contactButtonClass}>
                                    <WhatsAppIcon className="h-4 w-4" />
                                    {t.contactSpeakCeo}
                                </button>
                                <button onClick={() => navigate(`/${lang}/contactAgentA?intent=list`)} className={contactButtonClass}>
                                    <WhatsAppIcon className="h-4 w-4" />
                                    {t.contactChatAgent1}
                                </button>
                                <button onClick={() => navigate(`/${lang}/contactAgentB?intent=list`)} className={contactButtonClass}>
                                    <WhatsAppIcon className="h-4 w-4" />
                                    {t.contactChatAgent2}
                                </button>
                                <button onClick={showCallError} className={contactButtonClass}>
