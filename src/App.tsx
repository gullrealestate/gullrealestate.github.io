...
function App() {
    ...
    const translations = {
        ...
        ur: {
            ...
            heroTitle: "مردان میں مقیم، آپ کی قابلِ اعتماد پراپرٹی ایجنسی",
            heroSub: "سی ای او تک براہ راست رسائی اور مکمل شفافیت۔ ہم مقامی مہارت کے ساتھ پراپرٹی کی خرید، فروخت یا کرایہ داری کے ہر مرحلے میں آپ کی رہنمائی کرتے ہیں۔",
            heroBtn: "مفت مشورہ",
